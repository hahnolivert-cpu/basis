...
export default function Home() {
  ...
  // PerformanceCard (Tracking tab) tracks gross net worth, same basis as
  // WeeklyTotalCard/GoalProgressCard — crypto + equities + cash, not net of
  // debts, and not Angel Investment (weekly_snapshots never had that
  // bucket, so there's no history to compare it against).
